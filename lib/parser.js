...
module.exports = function(program) {
    ...
    var stringParser = consumer(stringRegEx, function(val){return {type: "Literal", value: matches[0].slice(1,matches[0].length-1)}})
    ...
    function expressionStatementParser() {
        ...
        // console.log("expressionStatementParser")
    ...
    function callExpressionParser() {
        // console.log("callExpressionParser")
        spaceParser()
    ...
    function binaryExpressionParser() {
        // console.log("binaryExpressionParser")
    ...
    function macroDeclarationParser() {
        ...
        // console.log("macroDeclarationParser")
    ...
    function functionDeclarationParser() {
        ...
        // console.log("functionDeclarationParser")
        var snippet = extractExpression()
        var rest = program.slice(snippet.length)
        program = snippet
        spaceParser()
    ...
    function variableDeclarationParser() {
        ...
        // console.log("variableDeclarationParser")
    ...
    function arrowFunctionParser() {
        ...
        // console.log("arrowFunctionParser")
        spaceParser()
        var snippet = extractExpression()
        var rest = program.slice(snippet.length)
        program = snippet
    ...
    function statementParser() {
        ...
        return arrowFunctionParser() || macroDeclarationParser()|| functionDeclarationParser() || variableDeclarationParser() || elementParser() || expressionStatementParser()
    }
