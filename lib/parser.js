...
module.exports = function(program) {
    ...
    function openParanthesesParser() {
    ...
    function closingParanthesesParser() {
    ...
    function functionKeywordParser() {
    ...
    function literalParser() {
        spaceParser()
        return nullParser() || booleanParser() || numberParser() || stringParser()
    }
